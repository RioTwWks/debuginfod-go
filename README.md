...
**Astra Linux / без доступа к `deb.debian.org` внутри контейнера** — соберите бинарник на хосте и используйте prebuilt-образ с репозиториями Astra:
...
Подробно: [deploy/docker/README.md](deploy/docker/README.md) (`APT_PROFILE=astra`, `DEBIAN_SUITE=buster`, оффлайн).
