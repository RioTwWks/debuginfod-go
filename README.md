...
**Astra Linux / без доступа к `deb.debian.org` внутри контейнера** — соберите бинарник на хосте и используйте prebuilt-образ:
...
# или: make docker-prebuilt
```

Подробно: [deploy/docker/README.md](deploy/docker/README.md) (зеркала APT, `DEBIAN_SUITE=bullseye`, оффлайн).
