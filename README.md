...
**Astra Linux / корпоративный прокси** — как в PVS-Studio-Tracker: в контейнере Debian APT + `HTTP_PROXY`, бинарник с хоста:
...
Подробно: [deploy/docker/README.md](deploy/docker/README.md) (прокси, Debian repos в контейнере, оффлайн).
