...
**Astra Linux** — `make docker-astra` (prebuilt + Astra APT + прокси/CA/GPG с хоста):
...
Подробно: [deploy/docker/README.md](deploy/docker/README.md).
...
| `DEBUGINFOD_LOG_LEVEL` | `-log-level` | Уровень slog (stdout) | `info` |
| `DEBUGINFOD_LOG_DIR` | — | Каталог ежедневных логов `debuginfod-YYYY-MM-DD.log` (в файле DEBUG) | — |
