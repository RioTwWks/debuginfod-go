...
- PostgreSQL: `DEBUGINFOD_DATABASE_URL` — `make docker-prep && make postgres-test-up` (APT/Astra, без Hub); см. [deploy/postgresql/README.md](../deploy/postgresql/README.md).
